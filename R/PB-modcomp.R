...
PBmodcomp <- function(largeModel, smallModel, nsim=1000, ref=NULL, cl=NULL, details=0, REML=FALSE){
  UseMethod("PBmodcomp")
}

PBmodcomp.merMod <- PBmodcomp.mer <- function(largeModel, smallModel, nsim=1000, ref=NULL, cl=NULL, details=0, REML=FALSE){
  ...
  if (is.null(ref)){
    ref <- PBrefdist(largeModel, smallModel, nsim=nsim, cl=cl, details=details, REML=REML)
  }
  ...
  LRTstat     <- getLRT(largeModel, smallModel, REML=REML)
...
PBmodcomp.lm <- function(largeModel, smallModel, nsim=1000, ref=NULL, cl=NULL, details=0, REML=FALSE){
